		...
		<div class="CONTAINER MEMBER">
			...
			<div class="col-lg-8 mx-auto px-md-3 px-0 editHouse">
				<div class="row houseTitle mb-4">
					<h1 class="col-auto title">新增房源</h1>
					<div class="col-sm">
						<!--<button class="ml-auto" onclick="location.href='subscribe.php'">預覽房源</button>-->
						<button class="ml-2" onclick="location.href='subscribe.php'">立刻升級</button>
					</div>
				</div>
					...
					<div class="tab-content" id="pills-tabContent">
						...
						<div class="tab-pane fade" id="pills-rent" role="tabpanel" aria-labelledby="pills-rent-tab">
							...
							<dl class="row mx-0 px-0 no-gutters HouseInfo">
								...
								<dd class="col-12">
									<label for="">頂樓加改</label>
									<input type="radio"> 是
									<input type="radio"> 否
								</dd>
								<dd class="col-12">
									<label for="">隔間材料</label>
									<input type="radio"> 無
									<input type="radio"> 水泥
									<input type="radio"> 木板
									<input type="radio"> 防火板
									<input type="radio"> 其他
									<input type="text">
								</dd>
								<dd class="col-12">
									<label for="">產權登記</label>
									<input type="radio"> 有
									<input type="radio"> 無
								</dd>
								<dd class="col-12">
